...
namespace unvell.ReoGrid.Demo
{
	public partial class DemoItemsForm : Form
	{
		...
		protected override void OnLoad(EventArgs e)
		{
			...
			linkDoc.LinkClicked += (s, e) =>
			{
				if (currentItem._demoInstance != null && currentItem.docUrl != null && !string.IsNullOrEmpty(currentItem.docUrl.val))
				{
					try
					{
						System.Diagnostics.Process.Start(new System.Diagnostics.ProcessStartInfo(string.Format("{0}/{1}", demoCategoryFile.baseSite, currentItem.docUrl.val))
						{
