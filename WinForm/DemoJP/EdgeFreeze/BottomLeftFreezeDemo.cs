...
{
	public partial class BottomLeftFreezeDemo : UserControl
	{
		public BottomLeftFreezeDemo()
		{
			InitializeComponent();
		}
		...
		protected override void OnLoad(EventArgs e)
		{
			...
			// freeze to bottom left
			worksheet.FreezeToCell(85, 5, FreezeArea.LeftBottom);
